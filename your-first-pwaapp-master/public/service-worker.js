...
/*
fetch - full offline expericne 이전에.  
...
If we left that check in, only the HTML would be served from the service worker cache.
Everything else would be requested from the network.
______________________
self.addEventListener('fetch', (evt) => {
  console.log('[ServiceWorker] Fetch', evt.request.url);
  // CODELAB: Add fetch event handler here.
